<template>
  <div id="answers" :class="{ hasAnswers: hasAnswers }">
    ...
    <DidYouKnow v-if="keyword.length > 0" :keyword="keyword" />
    <OneAnswer
...
export default {
  ...
  methods: {
    ...
    scrollToAnswer: function() {
      window.setTimeout(function() {
        try {
          ...
          const topStyle = window.getComputedStyle(
          ...
          document.querySelector('#top-bgfix').style.height = `${topHeight +
            32}px`;
        } catch {
    ...
    getAnswer: function(question = this.question) {
      ...
      var defaultResponse = [
        {
          ...
          snippet:
            'A sheet that is in the wind has come loose from its mooring and is flapping in the \nwind like a flag. A sail (normally jib sails) is said to be sheeted to the wind, when \nit ...',
          pagemap: {}
        },
        {
          ...
          snippet:
            "Very drunk. What's the origin of the phrase 'Three sheets to the wind'?. Our \ncolleagues at CANOE, the Committee to Ascribe a Nautical Origin ...",
          pagemap: {}
        },
        {
          cacheId: 'i3sieDgNhvYJ',
          link:
            'https://www.urbandictionary.com/define.php?term=three%20sheets%20to%20the%20wind',
          title: 'three sheets to the wind - Urban Dictionary',
          snippet:
            'Three sheets to the wind: The condition a person arrives at after imbibing too \nmuch alcohol. When a person is very drunk on the verge of being out of control.',
          pagemap: {}
        },
        {
          cacheId: 'nyt-sheets',
          ...
          title:
            "Opinion | What 'Three Sheets to the Wind' Means - The New York ...",
          snippet:
            'Dec 19, 1994 ... The true origin of "three sheets to the wind" was disclosed to me by a Nantucket \nsailor. Four sheets to the wind are O.K. because they are ...',
          pagemap: {}
        },
        {
          ...
          snippet:
            'Nautical. to trim, extend, or secure by means of a sheet or sheets. QUIZZES. Can \nYou Ace This Quiz About “Compliment” vs. “Complement”?',
          pagemap: {}
        },
        {
          ...
          snippet:
            'Aug 10, 2002 ... The word actually comes from an Old English term for the corner of a sail. The \nsheets were as vital in the days of three-masted square-rigged sea- ...',
          pagemap: {}
        },
        {
          ...
          title: 'Three Sheets to the Wind',
          snippet:
            "Three Sheets To The Wind: America's #1 Tribute To Yacht Rock is a well \nestablished, high energy party band specializing in the solid gold sounds of the \nlate ...",
          pagemap: {}
        },
        {
          cacheId: 'bualvoSa_LwJ',
          link:
            'https://www.amazon.com/Three-Sheets-Wind-Quest-Meaning/dp/0330442473',
          title:
        ...
        },
        {
          ...
          link:
            'https://www.ecenglish.com/learnenglish/lessons/why-do-we-say-three-sheets-wind',
          title: "Why do we say 'Three Sheets to the Wind'? | Learn English",
          snippet:
            "Apr 28, 2008 ... This expression is used to describe someone who is drunk to the point of being \nunable to stand up straight. The 'sheets' here refer to the sails of a ...",
          pagemap: {}
        },
        {
          cacheId: 'HYTdbKJKZMMJ',
          link:
            'https://www.hatterasrealty.com/vacation-rentals/three-sheets-wind-70-1',
          title:
            'Three Sheets to the Wind #70-1 -Hatteras Rental | Hatteras Realty',
          snippet:
            'THREE SHEETS TO THE WIND is a perfect place for a Hatteras Island vacation. \nTHREE SHEETS is nestled into a beautiful, natural, dune-top location on a quiet\n ...',
          pagemap: {}
        }
      ];
      ...
      const qString = `https://www.googleapis.com/customsearch/v1?key=${gKey}&cx=${gId}&q=${encodeURIComponent(
        question
      )}`;
      ...
      fetch(qString)
        ...
        .then(j => {
          // Check if question has keyword, to determine if special div is displayed
          this.screenForKeywords(question);
          // Now deal with displaying the answers
    ...
    screenForKeywords: function(question = this.question) {
      // Screens for keywords in question, to display special information if found
      const keywords = ['island'];
      // Have to set the keyword to something, so that keyword doesn't still display on searches after keyword search
      let newKey = '';
      // Will only trigger for last keyword found (by order in keywords array)
